...
svc = CatalogoSimpleService(Sistema, has_audit=True)
...
@router.post("", response_model=CatalogoDTO, status_code=status.HTTP_201_CREATED, summary="(ADMIN) Crear sistema")
...
@router.delete("/{id}", status_code=status.HTTP_204_NO_CONTENT, summary="(ADMIN) Eliminar sistema (soft-delete)")
